    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.policy:
                ...
                Toast.makeText(MainActivity.this, "Rating...me", Toast.LENGTH_SHORT).show();
            case R.id.more:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://search?q=search list")));
                // Toast.makeText(MainActivity.this, "Term and Conditions", Toast.LENGTH_SHORT).show();

                break;
            case R.id.website:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.teknologyupdate.com")));
